...
export const useLanguage = () => {
  ...
  const translations = {
    id: {
      ...
      // 3D Experience Page
      threed_title: 'DUNIA 3D TIGA DIMENSI',
      threed_desc: 'Eksplorasi animasi interaktif 3D Littlest Tokyo dan efek pencahayaan dinamis Spotlight Studio dengan Three.js dan WebGL.',
      threed_controls: 'KONTROL INTERAKTIF',
      threed_scene_select: 'PILIH SCENE 3D',
      threed_scene_tokyo: 'Littlest Tokyo 🏙️',
      threed_scene_spotlight: 'Spotlight Studio (Lucy Angel) 💡🗽',
      threed_anim: 'Animasi',
      threed_play: 'Putar',
      threed_pause: 'Jeda',
      threed_speed: 'Kecepatan',
      threed_camera: 'Sudut Kamera',
      threed_cam_iso: 'Isometrik',
      threed_cam_street: 'Jalan Depan',
      threed_cam_roof: 'Atap Kafe',
      threed_cam_top: 'Atas Langit',
      threed_theme: 'Atmosfer & Pencahayaan',
      threed_theme_day: 'Siang Pastel',
      threed_theme_sunset: 'Senja Emas',
      threed_theme_night: 'Cyberpunk Gelap',
      threed_theme_studio: 'Studio Minimalis',
      threed_spot_controls: 'Kontrol Lampu Spotlight',
      threed_spot_map: 'Tekstur Proyektor Lampu',
      threed_spot_map_disturb: 'Disturb (Abstrak)',
      threed_spot_map_colors: 'Colors (Prisma)',
      threed_spot_map_grid: 'UV Grid (Grid)',
      threed_spot_map_none: 'Clean White (Polos)',
      threed_spot_color: 'Warna Lampu',
      threed_spot_intensity: 'Intensitas Lampu',
      threed_spot_angle: 'Sudut Sorot (Angle)',
      threed_spot_penumbra: 'Kelembutan Tepi (Penumbra)',
      threed_spot_decay: 'Peluruhan (Decay)',
      threed_spot_distance: 'Jarak Jangkau (Distance)',
      threed_spot_shadow: 'Intensitas Bayangan (Shadow)',
      threed_spot_helper: 'Helper Cone Lampu',
      threed_spot_swing: 'Gerak Ayunan Lampu (Auto Swing)',
      threed_statue_mat: 'Material Patung',
      threed_mat_marble: 'Marmer Putih',
      threed_mat_bronze: 'Perunggu Antik',
      threed_mat_gold: 'Emas Berkilau',
      threed_mat_obsidian: 'Obsidian Gelap',
      threed_auto_rotate: 'Putar Otomatis',
      threed_wireframe: 'Wireframe',
      threed_grid: 'Grid Dasar',
      threed_reset: 'Reset Kamera',
      threed_fullscreen: 'Layar Penuh',
      threed_screenshot: 'Ambil Tangkapan Layar',
      threed_guide_rotate: 'Klik kiri & seret untuk memutar',
      threed_guide_zoom: 'Ctrl + Scroll atau tombol +/- untuk zoom',
      threed_guide_pan: 'Klik kanan & seret untuk menggeser',
      threed_ctrl_hint: 'Gunakan Ctrl + Scroll atau tombol +/- untuk zoom 3D',
      threed_loading: 'Memuat Model 3D...',
    ...
    en: {
      ...
      // 3D Experience Page
      threed_title: '3D KEYFRAME & SPOTLIGHT WORLD',
      threed_desc: 'Explore interactive 3D Littlest Tokyo and dynamic Spotlight Studio with textured light projections, shadows, and WebGL.',
      threed_controls: 'INTERACTIVE CONTROLS',
      threed_scene_select: 'SELECT 3D SCENE',
      threed_scene_tokyo: 'Littlest Tokyo 🏙️',
      threed_scene_spotlight: 'Spotlight Studio (Lucy Angel) 💡🗽',
      threed_anim: 'Animation',
      threed_play: 'Play',
      threed_pause: 'Pause',
      threed_speed: 'Speed',
      threed_camera: 'Camera Angle',
      threed_cam_iso: 'Isometric',
      threed_cam_street: 'Front Street',
      threed_cam_roof: 'Rooftop Cafe',
      threed_cam_top: 'Sky Top',
      threed_theme: 'Atmosphere & Lighting',
      threed_theme_day: 'Pastel Day',
      threed_theme_sunset: 'Golden Sunset',
      threed_theme_night: 'Cyberpunk Night',
      threed_theme_studio: 'Minimal Studio',
      threed_spot_controls: 'Spotlight Controls',
      threed_spot_map: 'Projector Light Texture',
      threed_spot_map_disturb: 'Disturb (Abstract)',
      threed_spot_map_colors: 'Colors (Prism)',
      threed_spot_map_grid: 'UV Grid (Grid)',
      threed_spot_map_none: 'Clean White (None)',
      threed_spot_color: 'Light Color',
      threed_spot_intensity: 'Light Intensity',
      threed_spot_angle: 'Cone Angle',
      threed_spot_penumbra: 'Edge Softness (Penumbra)',
      threed_spot_decay: 'Light Decay',
      threed_spot_distance: 'Max Distance',
      threed_spot_shadow: 'Shadow Intensity',
      threed_spot_helper: 'Spotlight Helper Cone',
      threed_spot_swing: 'Auto Light Swing',
      threed_statue_mat: 'Statue Material',
      threed_mat_marble: 'White Marble',
      threed_mat_bronze: 'Antique Bronze',
      threed_mat_gold: 'Gleaming Gold',
      threed_mat_obsidian: 'Dark Obsidian',
      threed_auto_rotate: 'Auto Rotate',
      threed_wireframe: 'Wireframe',
      threed_grid: 'Floor Grid',
      threed_reset: 'Reset Camera',
      threed_fullscreen: 'Fullscreen',
      threed_screenshot: 'Take Screenshot',
      threed_guide_rotate: 'Left-click & drag to orbit',
      threed_guide_zoom: 'Ctrl + Scroll or +/- buttons to zoom',
      threed_guide_pan: 'Right-click & drag to pan',
      threed_ctrl_hint: 'Use Ctrl + Scroll or +/- buttons to zoom 3D',
      threed_loading: 'Loading 3D Model...',
    ...
    zh: {
      ...
      // 3D Experience Page
      threed_title: '3D 关键帧与聚光灯世界',
      threed_desc: '使用 Three.js 和 WebGL 探索 Littlest Tokyo 3D 动画以及带有纹理投影和柔和阴影的动态 Spotlight Studio。',
      threed_controls: '交互控制台',
      threed_scene_select: '选择 3D 场景',
      threed_scene_tokyo: '东京街景 (Littlest Tokyo) 🏙️',
      threed_scene_spotlight: '聚光灯工作室 (Lucy 天使) 💡🗽',
      threed_anim: '动画',
      threed_play: '播放',
      threed_pause: '暂停',
      threed_speed: '速度',
      threed_camera: '摄像机视角',
      threed_cam_iso: '等轴测',
      threed_cam_street: '街景正面',
      threed_cam_roof: '屋顶咖啡',
      threed_cam_top: '俯视全景',
      threed_theme: '氛围与光照',
      threed_theme_day: '柔和日光',
      threed_theme_sunset: '金色落日',
      threed_theme_night: '赛博朋克夜景',
      threed_theme_studio: '极简工作室',
      threed_spot_controls: '聚光灯控制面板',
      threed_spot_map: '聚光灯投影纹理',
      threed_spot_map_disturb: 'Disturb (抽象纹理)',
      threed_spot_map_colors: 'Colors (棱镜光谱)',
      threed_spot_map_grid: 'UV Grid (网格)',
      threed_spot_map_none: '纯净白光 (无)',
      threed_spot_color: '聚光灯颜色',
      threed_spot_intensity: '光照强度',
      threed_spot_angle: '光束角度 (Angle)',
      threed_spot_penumbra: '边缘柔和度 (Penumbra)',
      threed_spot_decay: '光衰减度 (Decay)',
      threed_spot_distance: '最大照射距离',
      threed_spot_shadow: '阴影强度 (Shadow)',
      threed_spot_helper: '聚光灯辅助线锥 (Helper)',
      threed_spot_swing: '自动摆动光源 (Auto Swing)',
      threed_statue_mat: '雕像材质',
      threed_mat_marble: '白色大理石',
      threed_mat_bronze: '复古青铜',
      threed_mat_gold: '炫彩赛博金',
      threed_mat_obsidian: '暗黑黑曜石',
      threed_auto_rotate: '自动旋转',
      threed_wireframe: '线框模式',
      threed_grid: '地面网格',
      threed_reset: '重置视角',
      threed_fullscreen: '全屏模式',
      threed_screenshot: '截取高清图片',
      threed_guide_rotate: '鼠标左键拖拽旋转视角',
      threed_guide_zoom: 'Ctrl + 滚轮 或 +/- 按钮缩放',
      threed_guide_pan: '鼠标右键拖拽平移',
      threed_ctrl_hint: '使用 Ctrl + 滚轮 或 +/- 按钮缩放 3D 模型',
      threed_loading: '正在加载 3D 模型...',
    ...
    ja: {
      ...
      // 3D Experience Page
      threed_title: '3D キーフレーム＆スポットライトワールド',
      threed_desc: 'Three.js と WebGL で構築された Littlest Tokyo の 3D アニメーションや、テクスチャ投影とリアルな影を持つ Spotlight Studio を体験。',
      threed_controls: 'コントロールパネル',
      threed_scene_select: '3D シーン選択',
      threed_scene_tokyo: 'リトル東京 (Littlest Tokyo) 🏙️',
      threed_scene_spotlight: 'スポットライトスタジオ (Lucy 天使) 💡🗽',
      threed_anim: 'アニメーション',
      threed_play: '再生',
      threed_pause: '一時停止',
      threed_speed: '速度',
      threed_camera: 'カメラアングル',
      threed_cam_iso: 'アイソメトリック',
      threed_cam_street: 'ストリート正面',
      threed_cam_roof: '屋上カフェ',
      threed_cam_top: '上空トップ',
      threed_theme: '雰囲気・ライティング',
      threed_theme_day: 'パステルデイ',
      threed_theme_sunset: '夕暮れサンセット',
      threed_theme_night: 'サイバーパンクナイト',
      threed_theme_studio: 'ミニマルスタジオ',
      threed_spot_controls: 'スポットライト操作パネル',
      threed_spot_map: 'プロジェクター投影テクスチャ',
      threed_spot_map_disturb: 'Disturb (抽象模様)',
      threed_spot_map_colors: 'Colors (プリズム)',
      threed_spot_map_grid: 'UV Grid (グリッド)',
      threed_spot_map_none: 'クリーンホワイト (なし)',
      threed_spot_color: 'ライトカラー',
      threed_spot_intensity: '光の強度',
      threed_spot_angle: '照射角 (Angle)',
      threed_spot_penumbra: 'エッジのぼかし (Penumbra)',
      threed_spot_decay: '減衰 (Decay)',
      threed_spot_distance: '最大照射距離',
      threed_spot_shadow: '影の強度 (Shadow)',
      threed_spot_helper: 'スポットライトコーン (Helper)',
      threed_spot_swing: 'ライト自動スイング (Auto Swing)',
      threed_statue_mat: '像のマテリアル',
      threed_mat_marble: 'ホワイト大理石',
      threed_mat_bronze: 'アンティークブロンズ',
      threed_mat_gold: 'ゴールド (金)',
      threed_mat_obsidian: 'ダークオブシディアン',
      threed_auto_rotate: '自動回転',
      threed_wireframe: 'ワイヤーフレーム',
      threed_grid: 'フロアグリッド',
      threed_reset: 'カメラリセット',
      threed_fullscreen: 'フルスクリーン',
      threed_screenshot: 'スクリーンショット',
      threed_guide_rotate: '左クリック＋ドラッグで回転',
      threed_guide_zoom: 'Ctrl + スクロール または +/- ボタンでズーム',
      threed_guide_pan: '右クリック＋ドラッグで移動',
      threed_ctrl_hint: 'Ctrl + スクロール または +/- ボタンで3Dモデルをズーム',
      threed_loading: '3Dモデルを読み込み中...',
